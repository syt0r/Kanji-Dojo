...
class JvmBackupArchiveHandler : BackupArchiveHandler {
    ...
    override suspend fun writeBackupZip(
        ...
        output.javaFile.outputStream().use {
            ZipOutputStream(it).use {
                ...
                it.writeFile(backupInfo.userDatabaseFileName, database.javaFile)
            }
        }
    }
    ...
    private inline fun <T> PlatformFile.withZipEntry(
        ...
        return javaFile.inputStream().use {
